...
export default function Search(props: ISearch) {
    ...
    return (
        <div className="relative">
            ...
            <input onChange={onChange} value={value} ref={searchInputRef} placeholder="Search" type="text" role="search" {...props} className="text-gray-950 w-[44rem] text-lg leading-5 block p-5 focus:border-blue-500 pl-12 justify-between items-center rounded-2xl border border-[#CBD5E1] bg-white" />
            {endAdornment && (
